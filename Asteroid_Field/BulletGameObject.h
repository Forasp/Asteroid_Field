...
class BulletGameObject : public GameObject, public Collidable
{
public:
	BulletGameObject(Game* _Game, GameObject* _Parent = nullptr) : GameObject(_Game, _Parent) { InitializeGameObject(); }
